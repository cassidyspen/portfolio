...
When a card is clicked:
	1	The card flips to reveal the front side
	2	The card expands toward the center of the screen
	3	The rest of the page becomes slightly blurred and darkened
	4	The front of the card displays detailed information
This interaction mimics physically picking up a card from a table and turning it over.
...
The back design includes:
	...
	•	gold accents
This resembles the back of a traditional deck of cards.
...
Cards are arranged in rows under each hand heading.
...
This creates a feeling that the card can be picked up.



Click Behavior
When a card is clicked:
	1	The card rotates on the Y-axis (flip animation)
	2	The card expands toward the center of the screen
	3	Background cards become blurred and dimmed
	4	The front of the card displays detailed information
The expanded card occupies roughly 60–70% of the screen width.



Closing a Card
Users can close the card by:
...
Architecture Flow
User Browser ↓ CloudFront CDN ↓ S3 (React frontend) ↓ Flask API (Elastic Beanstalk)
